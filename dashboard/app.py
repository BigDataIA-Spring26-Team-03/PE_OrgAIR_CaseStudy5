...
ALL data comes from CS1-CS4 via PortfolioDataService — no mock data.
...
try:
    ...
    st.info("Ensure the scoring service is running.")
    st.stop()

# ---------------------------------------------------------------------------
# Fund-AI-R metrics (Task 10.5 integration)
# ---------------------------------------------------------------------------
ev_map       = {c.company_id: 100.0 for c in companies}  # equal-weight EV
...
# ---------------------------------------------------------------------------
# Optional evidence panel (requires CS4 justification calls)
# ---------------------------------------------------------------------------
if show_evidence:
    st.markdown("---")
    ...
    st.info(
        ...
        "Trigger via the LangGraph agent workflow (Task 10.4) or the Score Justification page."
    )
