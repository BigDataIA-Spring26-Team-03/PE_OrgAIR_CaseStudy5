"""Fund-AI-R Calculator — Portfolio-level AI-readiness aggregation (Task 10.5)."""
...
from src.services.integration.portfolio_data_service import PortfolioCompanyView
...
class FundMetrics:
    ...
    sector_hhi: float                    # Herfindahl-Hirschman Index
...
class FundAIRCalculator:
    ...
    def calculate_fund_metrics(
        ...
        quartile_dist: Dict[int, int] = {1: 0, 2: 0, 3: 0, 4: 0}
        for c in companies:
        ...
        hhi = (
            sum((ev / total_ev) ** 2 for ev in sector_ev.values())
        ...
        logger.info("fund_air_calculated", fund_id=fund_id, fund_air=metrics.fund_air)
        return metrics
